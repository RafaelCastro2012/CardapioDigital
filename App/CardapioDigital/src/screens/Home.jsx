...
import { ScrollView, View, Image, StyleSheet, TextInput, Text } from "react-native";
...
import boloDeCoco from '../../res/img/boloDeCoco.png';
        ...
        <SafeAreaProvider>
            <SafeAreaView style={{ flex: 1, backgroundColor: '#3E3327' }}>
                <ScrollView>
                    ...
                    <View style={{ flexDirection: "row" }}>
                    <View style={styles.cards}>
                            <Image style={styles.imgProdutos} source={boloDeCoco} />
                            <Text style={{fontFamily: 'PatuaOne-Regular',textAlign: 'center',fontSize: 18,padding: 20}}>BOLO DE COCO</Text>
                        </View>
                        <View style={styles.cards}>
